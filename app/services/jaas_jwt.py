...
class JaaSJwtBuilder:
    ...
    def signWith(self, key):
        ...
        """
        context = { 'user': self.userClaims, 'features': self.featureClaims,  "room": { "regex": "false"} }
    ...
    def get_token(self, email = '', name = '', room = '', moderator = False ):
        fp = os.path.abspath('auth.pk')
        with open(fp, 'r') as reader:
            return self.withDefaults() \
                .withApiKey("vpaas-magic-cookie-2245ac56e2d94efe9ab7ef727989f4b1/96c04e") \
                    .withUserName(name) \
                        .withUserEmail(email) \
                            .withModerator(moderator) \
                                .withAppID("vpaas-magic-cookie-2245ac56e2d94efe9ab7ef727989f4b1") \
                                    .withRoomName(room) \
